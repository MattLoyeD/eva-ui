...
```tsx
import { Drawer } from "@mdrbx/nerv-ui";
```

## Basic Usage

<Callout type="info" title="INTERACTIVE">
  Click the button to open the drawer. Click the [X] button or the backdrop to
  close.
</Callout>
...
<PropsTable
  props={[
    ...
    },
    {
      name: "title",
      type: "string",
      description: "Header title displayed in the title bar",
    },
    {
      name: "side",
      type: '"left" | "right"',
    ...
    },
    {
      ...
      type: "string",
      default: '"400px"',
      description: "Drawer width (any CSS value)",
    },
    {
      name: "color",
      type: '"orange" | "green" | "cyan"',
      default: '"orange"',
      description: "Color theme for borders, text, and glow",
    },
