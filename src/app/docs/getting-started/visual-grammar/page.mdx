...
<ComponentPreview title="STRUCTURAL PANEL">
  <div className="max-w-sm">
    <Card title="MAGI STATUS">
      <div className="space-y-1 text-xs text-nerv-white/80" style={{ fontFamily: "var(--font-nerv-mono)" }}>
...
<ComponentPreview title="CAMERA OVERLAY">
  <div className="relative overflow-hidden border border-nerv-mid-gray/50 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.1),transparent_35%),linear-gradient(180deg,#181818_0%,#020202_100%)] p-5">
    ...
    <div className="relative ml-auto max-w-sm">
      <Card title="TEST PLUG-02" variant="video" footer="HARMONICS TEST PROCEEDING">
        <div className="space-y-1 text-[10px] uppercase tracking-[0.12em] text-nerv-orange/80" style={{ fontFamily: "var(--font-nerv-mono)" }}>
