...
export const docsNavigation: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "EVA CHECKBOX", href: "/docs/components/eva-checkbox" },
      { title: "EVA TOGGLE", href: "/docs/components/eva-toggle" },
      { title: "EVA TEXTAREA", href: "/docs/components/eva-textarea" },
      { title: "EVA TOOLTIP", href: "/docs/components/eva-tooltip" },
      { title: "EVA BADGE", href: "/docs/components/eva-badge" },
      { title: "EVA SKELETON", href: "/docs/components/eva-skeleton" },
      { title: "EVA BREADCRUMB", href: "/docs/components/eva-breadcrumb" },
      { title: "EVA PAGINATION", href: "/docs/components/eva-pagination" },
      { title: "EVA RADIO GROUP", href: "/docs/components/eva-radio-group" },
      { title: "EVA DRAWER", href: "/docs/components/eva-drawer" },
      { title: "EVA DIVIDER", href: "/docs/components/eva-divider" },
      { title: "EVA THEME PROVIDER", href: "/docs/components/eva-theme-provider" },
    ],
  },
  {
    title: "EXAMPLES",
