...
export const TargetingReticle = forwardRef<HTMLDivElement, TargetingReticleProps>(
  function TargetingReticle(
    ...
    return (
      <div ref={ref} className={`relative inline-block ${className}`} style={{ width: size, height: size }} {...rest}>
        <svg
          width={size}
          height={size}
