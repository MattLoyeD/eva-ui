  ...
  return (
    <nav className="w-64 shrink-0 min-h-screen bg-eva-dark-gray border-r border-eva-mid-gray overflow-y-auto">
      ...
      <div className="px-4 py-4 border-b border-eva-mid-gray">
        ...
        <div className="text-[10px] font-mono text-eva-mid-gray mt-0.5">
      ...
      {docsNavigation.map((section, si) => (
        <div key={section.title} className="py-3">
          <h4
            className="px-4 text-[10px] uppercase tracking-[0.3em] text-eva-mid-gray font-bold mb-2"
            style={{ fontFamily: "var(--font-eva-display)" }}
          >
                    ...
                    className={`
                      ...
                      ${
                        isActive
                          ...
                          : "text-eva-white/60 border-transparent hover:text-eva-orange hover:border-eva-orange/50"
                      }
                    `}
                    style={{ fontFamily: "var(--font-eva-display)" }}
                  >
      ...
      <div className="px-4 py-3 border-t border-eva-mid-gray mt-8">
        <div className="text-[9px] font-mono text-eva-mid-gray/50 space-y-0.5">
          <div>EVA-UI v0.1.0</div>
          <div>NERV DOCUMENTATION SYSTEM</div>
          <div className="mt-1">
            <Link
              href="https://github.com/MattLoyeD/eva-ui"
              className="text-eva-cyan/40 hover:text-eva-cyan transition-colors"
            >
              GITHUB REPOSITORY
            </Link>
          </div>
